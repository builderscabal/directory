...
const EmbedUrl = ({ userId }: UserProps) => {
                ...
                <div className="">
                  ...
                  >
                    <GradientHeading size="xs">
                      Select a startup to embed a demo
                    </GradientHeading>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            <span className="text-blue-500">Platforms supported:</span> youtube, loom, vimeo, wistia, facebook, twitch, tiktok, instagram, brightcove, & jw player
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
