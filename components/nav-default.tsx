...
export function NavDefaultSidebar({
  sectors,
  categories,
  industries,
}: {
          ...
          <DropdownMenu>
            ...
            >
              <div className="p-[1px] bg-background rounded-md">
                <DropdownMenuLabel>Directory | BuildersCabal</DropdownMenuLabel>
                <DropdownMenuSeparator className="bg-primary" />
                <DropdownMenuItem>
                  <Link href="/sign-in">
                    <Button className="w-full hover:text-red-500">
                      <LogInIcon className="mr-1 stroke-red-500 size-4" /> Login
                    </Button>
                  </Link>
                </DropdownMenuItem>
              </div>
...
function StartupNav({
  ...
  return (
    <div className="">
      <DirectoryLogo />
      {children}
      <ScrollArea className="h-[calc(100vh-400px)] md:h-[calc(100vh-200px)] pb-4 flex flex-col gap-4 pl-2">
...
export function DirectoryLogo() {
  return (
    <Link href="/">
      <img
        className="size-12 mb-1.5 rounded-lg object-cover"
